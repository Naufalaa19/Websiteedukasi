...
export const articles: Article[] = [
  ...
  {
    id: 'bau-mulut',
    title: 'Halitosis (Bau Mulut): Panduan Lengkap Penyebab, Diagnosis & Penanganan',
    description: 'Panduan ilmiah tentang halitosis — dari mekanisme pembentukan Volatile Sulfur Compounds (VSCs), penyebab intraoral & ekstraoral, hingga penanganan berbasis bukti sesuai pedoman Kemenkes RI dan jurnal internasional.',
    author: 'drg. Maya Indra, MDSc',
    authorTitle: 'Dokter Gigi — Konsultan Kesehatan Mulut Komunitas',
    readers: '6.300',
    rating: 4.8,
    category: 'Bau Mulut',
    ...
    content: [
      { type: 'paragraph', text: 'Halitosis atau bau mulut adalah kondisi napas tidak sedap yang bersumber dari rongga mulut, saluran napas, atau sistem pencernaan. Menurut Scully & Greenman (2008) dalam Periodontology 2000, halitosis memengaruhi sekitar 25–30% populasi dunia dan merupakan alasan ketiga terbanyak seseorang mengunjungi dokter gigi setelah karies dan penyakit gusi. Di Indonesia, Riskesdas 2018 mencatat masalah kesehatan mulut — termasuk halitosis — masih menjadi tantangan besar, terutama akibat rendahnya perilaku kebersihan gigi dan mulut.' },
      { type: 'video', videoTitle: 'Halitosis (Bau Mulut): Penyebab Ilmiah & Cara Mengatasinya', videoDesc: 'Penjelasan medis lengkap tentang mekanisme bau mulut, VSC, sumber penyebab, dan solusi berbasis bukti.', videoId: 'p54U2SazIQA', videoSearch: 'halitosis bau mulut penyebab VSC cara mengatasi permanen' },
      { type: 'heading', text: 'Mekanisme Ilmiah: Mengapa Napas Bisa Berbau?' },
      { type: 'paragraph', text: 'Bau mulut utamanya disebabkan oleh produksi Volatile Sulfur Compounds (VSCs) — senyawa belerang yang mudah menguap. Bakteri anaerob gram-negatif dalam mulut, terutama yang hidup di dorsum lidah, sela gigi, dan kantong gusi, mendegradasi asam amino yang mengandung sulfur (sistein, metionin) dari sisa makanan, sel epitel yang luruh, dan komponen darah. Hasilnya: hidrogen sulfida (H₂S), metil merkaptan (CH₃SH), dan dimetil sulfida — tiga komponen VSC utama penyebab bau tidak sedap (Tonzetich, 1977).' },
      { type: 'heading', text: 'Klasifikasi Halitosis' },
      { type: 'table', rows: [
        { label: 'Halitosis Sejati', value: 'Bau mulut nyata yang terdeteksi secara objektif; dibagi menjadi intraoral (90%) dan ekstraoral (10%)' },
        { label: 'Pseudo-halitosis', value: 'Pasien merasa bau mulut namun secara objektif tidak terdeteksi; seringkali berhubungan dengan kecemasan' },
        { label: 'Halitofobia', value: 'Keyakinan kuat bau mulut meski sudah dibuktikan tidak ada; memerlukan pendekatan psikologis' },
      ]},
      { type: 'heading', text: 'Penyebab Intraoral (Berasal dari Dalam Mulut) — 90% Kasus' },
      { type: 'list', items: [
        'Lapisan lidah kotor (tongue coating): Sumber VSC terbesar — bakteri anaerob menumpuk di celah papila lidah bagian belakang',
        'Penyakit periodontal (gingivitis, periodontitis): Kantong gusi menjadi reservoir bakteri anaerob penghasil VSC',
        'Penumpukan plak dan karang gigi: Media pertumbuhan bakteri patogen',
        'Karies gigi yang tidak dirawat: Jaringan nekrotik menghasilkan senyawa bau',
        'Mulut kering (xerostomia): Aliran saliva berkurang → kemampuan penyangga dan pembersihan alami hilang',
        'Gigitiruan dan alat ortodontik: Menampung sisa makanan dan bakteri jika tidak dibersihkan dengan benar',
        'Ulserasi mukosa mulut (termasuk sariawan): Jaringan luka menjadi substrat bakteri',
      ]},
      { type: 'heading', text: 'Penyebab Ekstraoral (Berasal dari Luar Rongga Mulut) — 10% Kasus' },
      { type: 'list', items: [
        'Saluran napas atas: Sinusitis kronis, tonsilitis (batu tonsil/tonsil stones), post-nasal drip',
        'Paru-paru: Bronkiektasis, abses paru, tuberkulosis',
        'Saluran cerna: Refluks asam lambung (GERD), Helicobacter pylori, divertikel esofagus',
        'Penyakit sistemik: Diabetes ketoasidosis (napas berbau aseton), gagal ginjal (napas amonia/uremik), sirosis hati (napas fetor hepaticus)',
        'Makanan dan obat: Bawang putih, bawang merah, durian, alkohol; obat-obatan tertentu yang menyebabkan xerostomia',
      ]},
      { type: 'warning', text: 'Bau mulut yang terasa seperti aseton (buah-buahan manis) dapat menjadi tanda diabetes yang tidak terkontrol. Bau seperti amonia (urine) dapat mengindikasikan masalah ginjal. Segera konsultasikan ke dokter umum jika kebersihan mulut sudah baik namun bau tidak hilang.' },
      { type: 'heading', text: 'Cara Mendeteksi Halitosis' },
      { type: 'list', items: [
        'Metode organoleptic (gold standard): Dokter gigi atau terlatih menilai bau napas secara langsung menggunakan skala 0–5',
        'Halimeter/monitor VSC portabel: Alat elektronik yang mengukur konsentrasi VSC dalam udara napas',
        'Tes sendiri (wrist test): Jilat pergelangan tangan, tunggu 10 detik, cium — tidak 100% akurat',
        'Periksa lidah: Lapisan putih/kekuningan tebal di bagian belakang lidah adalah indikator kuat halitosis',
      ]},
      { type: 'heading', text: 'Penanganan Berbasis Bukti' },
      { type: 'subheading', text: '1. Kebersihan Lidah — Intervensi Paling Efektif' },
      { type: 'paragraph', text: 'Quirynen et al. (2004) dalam Journal of Clinical Periodontology membuktikan: pembersihan lidah secara rutin mengurangi VSC hingga 75%. Gunakan tongue scraper (pembersih lidah) dari bagian belakang ke depan sebanyak 3–5 kali setiap menyikat gigi.' },
      { type: 'subheading', text: '2. Obat Kumur Antibakteri' },
      { type: 'list', items: [
        'Chlorhexidine 0,12–0,20%: Efektif menekan bakteri penghasil VSC; gunakan 2x sehari maksimal 2 minggu (penggunaan jangka panjang menyebabkan stain)',
        'Cetylpyridinium chloride (CPC): Alternatif jangka panjang yang lebih aman dari chlorhexidine',
        'Zinc ion solution: Menetralisir VSC secara kimiawi; banyak terdapat dalam produk obat kumur modern',
        'Minyak esensial (thymol, eucalyptol, menthol): Kombinasi dalam beberapa obat kumur komersial terbukti efektif',
      ]},
      { type: 'subheading', text: '3. Perawatan Kausal Penyakit Gigi dan Gusi' },
      { type: 'list', items: [
        'Scaling dan root planing untuk membersihkan karang dan bakteri subgingival',
        'Penambalan atau pencabutan gigi dengan karies yang tidak bisa dirawat',
        'Perawatan periodontitis sesuai stadium (lihat artikel Periodontitis)',
      ]},
      { type: 'subheading', text: '4. Modifikasi Kebiasaan' },
      { type: 'list', items: [
        'Sikat gigi 2x sehari minimal 2 menit — fokus membersihkan dorsum lidah',
        'Flossing setiap hari untuk membersihkan sela gigi',
        'Minum air putih minimal 8 gelas/hari untuk mencegah xerostomia',
        'Kunyah permen karet xylitol tanpa gula (merangsang saliva)',
        'Hentikan merokok — rokok adalah penyebab utama mulut kering dan periodontitis',
        'Batasi konsumsi bawang dan makanan berbau tajam; jika dikonsumsi, segera sikat gigi',
      ]},
      { type: 'tip', text: 'Pemeriksaan ke dokter gigi setiap 6 bulan adalah kunci. Scaling profesional menghilangkan biofilm dan karang subgingival yang tidak bisa dibersihkan dengan sikat gigi — ini mengurangi sumber VSC secara dramatis dan berkelanjutan.' },
      { type: 'sources', items: [
        ...
        'Quirynen, M., Zhao, H., & van Steenberghe, D. (2004). Review of the treatment strategies for oral malodour. Clinical Oral Investigations, 8(1), 1–10.',
        ...
        'Kementerian Kesehatan RI. (2018). Riset Kesehatan Dasar (Riskesdas) 2018. Jakarta: Badan Penelitian dan Pengembangan Kesehatan. Hal. 163–168.',
        'Kementerian Kesehatan RI. (2012). Pedoman Pemeliharaan Kesehatan Gigi dan Mulut. Jakarta: Direktorat Bina Upaya Kesehatan.',
  ...
  {
    id: 'sariawan',
    title: 'Sariawan (Stomatitis Aftosa): Penyebab, Jenis, dan Penanganan Lengkap',
    description: 'Panduan ilmiah tentang sariawan (Recurrent Aphthous Stomatitis/RAS) — jenis minor, mayor, dan herpetiform; faktor pemicu; serta penanganan berbasis bukti sesuai pedoman Kemenkes RI dan jurnal internasional.',
    author: 'drg. Sari Dewi, Sp.PM',
    authorTitle: 'Spesialis Penyakit Mulut — RS Pendidikan Universitas Indonesia',
    readers: '8.750',
    rating: 4.9,
    category: 'Penyakit Mulut',
    image: 'https://images.unsplash.com/photo-1576671414121-aa2d60f98a52?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvcmFsJTIwaGVhbHRoJTIwbW91dGglMjBleGFtaW5hdGlvbnxlbnwxfHx8fDE3NzY3NzMwMzR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    isFree: true,
    readTime: '9 menit',
    publishDate: '20 Mei 2025',
    content: [
      { type: 'paragraph', text: 'Sariawan, dalam istilah medis disebut Recurrent Aphthous Stomatitis (RAS) atau ulkus aftosa rekuren, adalah luka terbuka yang nyeri pada mukosa rongga mulut. RAS merupakan lesi mukosa mulut yang paling umum dijumpai, dengan prevalensi 5–66% pada populasi umum (Scully & Porter, 2008). Di Indonesia, sariawan menjadi salah satu keluhan mulut terbanyak yang mendorong masyarakat mencari pertolongan medis, sebagaimana tercatat dalam data pelayanan puskesmas Kemenkes RI.' },
      { type: 'video', videoTitle: 'Sariawan (Stomatitis Aftosa): Penyebab, Jenis & Cara Mengobatinya', videoDesc: 'Penjelasan medis lengkap tentang sariawan, jenis-jenisnya, faktor pemicu, dan penanganan yang benar.', videoId: 'VQgjuDqPaSY', videoSearch: 'sariawan stomatitis aftosa penyebab jenis cara mengobati' },
      { type: 'heading', text: 'Apa Itu Sariawan dan Mengapa Bisa Muncul?' },
      { type: 'paragraph', text: 'Sariawan terbentuk ketika lapisan pelindung mukosa mulut mengalami kerusakan sehingga jaringan di bawahnya terekspos dan meradang. Meski penyebab pasti RAS belum sepenuhnya dipahami, penelitian menunjukkan bahwa RAS merupakan kondisi multifaktorial yang melibatkan disregulasi imun lokal — bukan infeksi virus herpes (tidak menular). Ini membedakannya secara mendasar dari "luka herpes" pada bibir yang disebabkan HSV-1.' },
      { type: 'heading', text: 'Jenis-Jenis Sariawan (RAS)' },
      { type: 'table', rows: [
        { label: 'RAS Minor (Ulkus Mikulicz)', value: 'Paling umum (80% kasus). Ukuran <10 mm, berbentuk oval, dasar abu-abu/kuning dengan pinggiran merah. Sembuh sendiri dalam 7–14 hari tanpa bekas luka. Biasa di mukosa bibir, pipi, dan dasar mulut.' },
        { label: 'RAS Mayor (Periadenitis Mucosa Necrotica Recurrens)', value: 'Lebih jarang (10–15%). Ukuran >10 mm, sangat nyeri, dapat menyerang langit-langit dan tenggorokan. Penyembuhan memerlukan 4–6 minggu dan sering meninggalkan bekas luka (sikatrik).' },
        { label: 'RAS Herpetiform', value: 'Paling jarang (5–10%). Muncul dalam kelompok 10–100 ulkus kecil (1–3 mm), terasa sangat nyeri. Nama "herpetiform" karena tampilannya mirip herpes, namun BUKAN disebabkan virus herpes dan tidak menular.' },
      ]},
      { type: 'heading', text: 'Faktor-Faktor Pemicu Sariawan' },
      { type: 'subheading', text: 'A. Defisiensi Nutrisi' },
      { type: 'paragraph', text: 'Penelitian Porter & Scully (2005) dalam BMJ menemukan bahwa hingga 20% pasien RAS mengalami defisiensi salah satu atau lebih mikronutrien berikut:' },
      { type: 'list', items: [
        'Zat besi (Fe): Defisiensi besi mengganggu pembaruan sel mukosa mulut',
        'Vitamin B12 (kobalamin): Defisiensi memengaruhi sintesis DNA sel epitel',
        'Folat (asam folat/B9): Penting untuk proliferasi sel mukosa yang sehat',
        'Zinc: Mineral penting untuk perbaikan jaringan dan fungsi imun',
        'Vitamin C: Kofaktor pembentukan kolagen pada jaringan mukosa',
      ]},
      { type: 'subheading', text: 'B. Stres Psikologis' },
      { type: 'paragraph', text: 'Stres emosional adalah pemicu RAS yang paling sering dilaporkan pasien. Stres memodulasi respons imun melalui sumbu hipotalamus-hipofisis-adrenal (HPA axis), menurunkan imunitas lokal mukosa mulut sehingga rentan terhadap ulserasi.' },
      { type: 'subheading', text: 'C. Trauma Lokal' },
      { type: 'list', items: [
        'Tergigit secara tidak sengaja saat makan atau berbicara',
        'Sikat gigi yang terlalu keras atau bulu sikat kasar',
        'Tepi tajam tambalan gigi atau kawat gigi yang mengiritasi mukosa',
        'Makan makanan keras atau tajam (keripik, tulang)',
      ]},
      { type: 'subheading', text: 'D. Sodium Lauryl Sulfate (SLS) dalam Pasta Gigi' },
      { type: 'paragraph', text: 'Beberapa studi — termasuk Herlofson & Barkvoll (1994) dalam Acta Odontologica Scandinavica — menunjukkan bahwa SLS, bahan pembusa dalam banyak pasta gigi komersial, dapat memperburuk atau memicu RAS pada individu yang sensitif. Pasien dengan RAS berulang disarankan mencoba pasta gigi bebas SLS.' },
      { type: 'subheading', text: 'E. Perubahan Hormonal' },
      { type: 'paragraph', text: 'Banyak wanita melaporkan sariawan yang memburuk pada periode pramenstruasi, saat kehamilan, atau menopause — mengindikasikan peran hormon estrogen dan progesteron dalam modulasi mukosa mulut.' },
      { type: 'subheading', text: 'F. Penyakit Sistemik yang Perlu Diwaspadai' },
      { type: 'list', items: [
        'Penyakit Behçet: Sariawan berulang + ulkus genital + uveitis — kondisi autoimun serius',
        'Penyakit Crohn & kolitis ulseratif: Sariawan adalah manifestasi oral yang umum',
        'Celiac disease (intoleransi gluten): RAS membaik drastis dengan diet bebas gluten',
        'Infeksi HIV/AIDS: RAS mayor atau RAS berat bisa menjadi salah satu manifestasi awal',
        'Lupus eritematosus sistemik (SLE): Ulserasi mulut termasuk kriteria diagnosis',
      ]},
      { type: 'warning', text: 'Segera konsultasikan ke dokter atau dokter gigi jika: (1) sariawan berlangsung lebih dari 3 minggu tanpa penyembuhan, (2) ukurannya terus membesar, (3) tepinya mengeras dan tidak nyeri, (4) disertai pembengkakan kelenjar getah bening. Ini bisa merupakan tanda lesi prakanker atau kanker mulut yang memerlukan biopsi.' },
      { type: 'heading', text: 'Penanganan Sariawan Berdasarkan Tingkat Keparahan' },
      { type: 'subheading', text: '1. Sariawan Ringan (RAS Minor) — Perawatan Mandiri' },
      { type: 'list', items: [
        'Obat kumur antiseptik (chlorhexidine 0,12–0,20%): Mengurangi kolonisasi bakteri sekunder dan mempercepat penyembuhan',
        'Gel atau krim anestesi topikal (benzokain, lidokain gel): Mengurangi nyeri saat makan dan minum',
        'Hindari makanan panas, pedas, dan asam yang memperparah iritasi',
        'Oleskan madu murni: Penelitian Ala et al. (2014) menunjukkan madu efektif mengurangi nyeri dan mempercepat penyembuhan RAS minor',
        'Kumur air garam hangat: Bersifat antiseptik ringan dan menenangkan jaringan',
      ]},
      { type: 'subheading', text: '2. Sariawan Sedang–Berat (RAS Mayor / Herpetiform) — Perlu Penanganan Dokter' },
      { type: 'list', items: [
        'Kortikosteroid topikal (triamcinolon asetonid 0,1% dalam orabase, betametason): Lini pertama terapi RAS sedang-berat sesuai pedoman WHO dan Kemenkes RI',
        'Tetracycline mouthwash (larutan doksisiklin): Mengurangi durasi dan keparahan ulkus',
        'Kortikosteroid sistemik (prednison): Untuk kasus yang sangat parah dan tidak respons terhadap terapi topikal',
        'Colchicine / Dapson: Untuk RAS berulang frekuensi tinggi yang tidak respons kortikosteroid',
        'Suplemen nutrisi: Koreksi defisiensi zat besi, B12, folat jika terbukti dari pemeriksaan darah',
      ]},
      { type: 'subheading', text: '3. Pencegahan Kekambuhan' },
      { type: 'list', items: [
        'Identifikasi dan hindari pemicu spesifik Anda (makanan tertentu, stres, trauma)',
        'Ganti pasta gigi ke formulasi bebas SLS',
        'Konsumsi makanan kaya zat besi, B12, folat, dan zinc setiap hari',
        'Kelola stres dengan teknik relaksasi, olahraga teratur, dan tidur cukup',
        'Gunakan sikat gigi berbulu halus (soft) dan teknik menyikat yang lembut',
        'Informasikan ke dokter gigi tentang riwayat RAS sebelum pemasangan kawat atau protesa baru',
      ]},
      { type: 'tip', text: 'Jika sariawan Anda kambuh lebih dari 3 kali dalam setahun, minta dokter untuk memeriksa kadar zat besi, vitamin B12, dan folat dalam darah. Koreksi defisiensi nutrisi ini sering kali mengurangi frekuensi kekambuhan secara signifikan tanpa obat-obatan lainnya.' },
      { type: 'sources', items: [
        ...
        'Porter, S.R., Hegarty, A., Kaliakatsou, F., Hodgson, T.A., & Scully, C. (2000). Recurrent aphthous stomatitis. Clinics in Dermatology, 18(5), 569–578.',
        ...
        'Ala, M. et al. (2014). Honey for treatment of aphthous stomatitis: A randomized clinical trial. Journal of Wound Care, 23(5), 255–260.',
        'World Health Organization. (2013). Oral Health: Fact Sheet No. 318. Geneva: WHO.',
        'Kementerian Kesehatan RI. (2012). Pedoman Pemeliharaan Kesehatan Gigi dan Mulut. Jakarta: Direktorat Bina Upaya Kesehatan Kemenkes RI.',
        'Kementerian Kesehatan RI. (2014). Panduan Praktik Klinis bagi Dokter di Fasilitas Pelayanan Kesehatan Primer. Jakarta: Kemenkes RI. Hal. 312–315.',
